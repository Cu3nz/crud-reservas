...
if (isset($_POST['btn'])){
    ...
    if (Utilidades::errorEmailRepetido('email' , $email)){
        $errores = true;
    }
    ...
    -> setImagen($imagen)
    -> create();
    $_SESSION['mensaje'] = "Reservada creada con exito";
...
<body style="background-color: burlywood;">
    <div class="container p-12 mx-auto">
        <h1 class="flex justify-center text-xl font-bold text-white m-3">Crear Reserva</h1>
            ...
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    <label for="descripcion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Personas</label>
                    <input type="number" name="personas" id="descripcion" placeholder="Numero de personas..." class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <?php 
                ...
                <div class="mb-6">
                    <label for="precio" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Comentarios</label>
                   <textarea name="comentarios" id="" cols="100" rows="10"></textarea>
                   <?php 
                ...
                <div class="mb-6">
                    <div class="flex w-full">
                        ...
                        <div class="w-1/2">
                            <img src="./img/default.jpeg" class="h-72 rounded w-full object-cover border-4 border-black" id="img">
                        </div>
                    </div>
                </div>
